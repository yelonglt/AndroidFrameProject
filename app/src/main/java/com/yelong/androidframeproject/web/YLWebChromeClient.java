 ...
 */
public class YLWebChromeClient extends WebChromeClient {
    private WebChromeClient mWrappedClient;

    protected YLWebChromeClient(WebChromeClient wrappedClient) {
    ...
    public void onExceededDatabaseQuota(String url, String databaseIdentifier, long currentQuota,
        ...
        mWrappedClient.onExceededDatabaseQuota(url, databaseIdentifier, currentQuota, estimatedSize, totalUsedQuota,
                quotaUpdater);
    }
    ...
    public void openFileChooser(ValueCallback<Uri> uploadFile) {
        ((YLWebChromeClient) mWrappedClient).openFileChooser(uploadFile);
    }
    ...
    public void openFileChooser(ValueCallback<Uri> uploadFile, String acceptType) {
        ((YLWebChromeClient) mWrappedClient).openFileChooser(uploadFile, acceptType);
    }
    ...
    public void openFileChooser(ValueCallback<Uri> uploadFile, String acceptType, String capture) {
        ((YLWebChromeClient) mWrappedClient).openFileChooser(uploadFile, acceptType, capture);
    }
    ...
    public boolean onShowFileChooser(WebView webView, ValueCallback<Uri[]> filePathCallback, FileChooserParams fileChooserParams) {
        return ((YLWebChromeClient) mWrappedClient).onShowFileChooser(webView, filePathCallback, fileChooserParams);
    }
}
