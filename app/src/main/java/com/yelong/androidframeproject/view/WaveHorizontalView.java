...
public class WaveHorizontalView extends View {
    ...
    public WaveHorizontalView(Context context) {
        this(context, null);
    }

    public WaveHorizontalView(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public void setWaveAnimationListener(OnWaveAnimationListener waveAnimationListener) {
        mWaveAnimationListener = waveAnimationListener;
    }
