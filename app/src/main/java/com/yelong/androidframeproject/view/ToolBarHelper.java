...
/**
 * Created by yelong on 2016/2/26.
 */
public class ToolBarHelper {
    ...
    * */
    ...
    private void initUserView(int id) {
        ...
        /*获取主题中定义的toolbar的高度*/
        int toolBarSize = (int) typedArray.getDimension(R.styleable.Toolbar_android_minHeight, (int) mContext.getResources().getDimension(R.dimen.abc_action_bar_default_height_material));
        typedArray.recycle();
        /*如果是悬浮状态，则不需要设置间距*/
